...
1. Кто: Какой пользователь вошел в систему, выполнил команду или загрузил файл
...
1. оповещение указывает на крупную кибер атаку требующую более глубокого расследования
